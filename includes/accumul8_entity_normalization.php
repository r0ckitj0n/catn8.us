...
if (!function_exists('accumul8_base_entity_family_definitions')) {
    function accumul8_base_entity_family_definitions(): array
    {
        ...
        $definitions = [
            ...
            [
                'parent_name' => 'Automation Direct',
                'match_rule' => 'Contains Automation Direct payroll or deposit text',
                'examples' => ['AutomationDirect Payroll', 'Automationdirect Direct Dep', 'AUTOMATIONDIRECT DIRECT DEP Jonathan D Graves May 1 - May 31'],
                'match_fragments' => ['automationdirect'],
                'match_contains' => ['automationdirect', 'automation direct', 'automationdirect payroll', 'automationdirect direct dep'],
            ],
            [
                'parent_name' => 'Hero App Subscription',
                'match_rule' => 'Contains Hero subscription billing text',
                'examples' => ['Hero App Subscription', 'Hero App Subscript', 'Herohealth. Co'],
                'match_fragments' => ['heroappsubscript', 'heroappsubscription', 'herohealth'],
                'match_contains' => ['hero app subscript', 'hero app subscription', 'herohealth'],
            ],
            [
                'parent_name' => 'Ionos',
                'match_rule' => 'Contains Ionos billing text',
                'examples' => ['Ionos', 'Ionos Inc.'],
                'match_fragments' => ['ionos'],
                'match_contains' => ['ionos inc', 'ionos'],
            ],
            [
                'parent_name' => "Jeremiah's Italian Gelato",
                'match_rule' => 'Contains Jeremiah\'s Italian Gelato text',
                'examples' => ["Jeremiah's", "Jeremiah's Italian Gelatos", 'PY JEREMIAH S ITALIAN'],
                'match_fragments' => ['jeremiahs', 'pyjeremiahsitalian'],
                'match_contains' => ["jeremiah's", 'jeremiah s italian', 'jeremiahs italian', 'py jeremiah s italian'],
            ],
            [
                'parent_name' => 'Monarch Money',
                'match_rule' => 'Contains Monarch Money text',
                'examples' => ['Monarch Money', 'Monarch Money App'],
                'match_fragments' => ['monarchmoney'],
                'match_contains' => ['monarch money'],
            ],
            [
                'parent_name' => 'Google GSuite SarahLG',
                'match_rule' => 'Contains Google GSuite SarahLG text',
                'examples' => ['GOOGLE GSUITE SARAHLG 650 253 0000 CA', 'GOOGLE GSUITE SARAHLG MOUNTAIN VIE CA'],
                'match_fragments' => ['googlegsuitesarahlg'],
                'match_contains' => ['google gsuite sarahlg'],
            ],
            [
                'parent_name' => 'Nayax Five Star Brea',
                'match_rule' => 'Contains Nayax Five Star Brea vending text',
                'examples' => ['Nayax Five Star Brea Cleveland', 'Nayax Five Star Brea Atlanta'],
                'match_fragments' => ['nayaxfivestarbrea'],
                'match_contains' => ['nayax five star brea'],
            ],
            [
