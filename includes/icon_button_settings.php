...
{
    $assetBasePath = '/dist/emojis/twemoji/';

    return [
        ['id' => 'heavy-plus', 'emoji' => '➕', 'codepoint' => '2795', 'asset_path' => $assetBasePath . '2795.png', 'label' => 'Heavy Plus'],
        ['id' => 'card-index-dividers', 'emoji' => '🗂', 'codepoint' => '1f5c2', 'asset_path' => $assetBasePath . '1f5c2.png', 'label' => 'Card Index Dividers'],
        ['id' => 'card-file-box', 'emoji' => '🗃', 'codepoint' => '1f5c3', 'asset_path' => $assetBasePath . '1f5c3.png', 'label' => 'Card File Box'],
        ['id' => 'file-cabinet', 'emoji' => '🗄', 'codepoint' => '1f5c4', 'asset_path' => $assetBasePath . '1f5c4.png', 'label' => 'File Cabinet'],
        ['id' => 'wastebasket', 'emoji' => '🗑', 'codepoint' => '1f5d1', 'asset_path' => $assetBasePath . '1f5d1.png', 'label' => 'Wastebasket'],
        ['id' => 'printer', 'emoji' => '🖨', 'codepoint' => '1f5a8', 'asset_path' => $assetBasePath . '1f5a8.png', 'label' => 'Printer'],
        ['id' => 'cross-mark', 'emoji' => '❌', 'codepoint' => '274c', 'asset_path' => $assetBasePath . '274c.png', 'label' => 'Cross Mark'],
        ['id' => 'question-mark', 'emoji' => '❓', 'codepoint' => '2753', 'asset_path' => $assetBasePath . '2753.png', 'label' => 'Question Mark'],
        ['id' => 'pencil', 'emoji' => '✏️', 'codepoint' => '270f', 'asset_path' => $assetBasePath . '270f.png', 'label' => 'Pencil'],
        ['id' => 'gear', 'emoji' => '⚙️', 'codepoint' => '2699', 'asset_path' => $assetBasePath . '2699.png', 'label' => 'Gear'],
        ['id' => 'information', 'emoji' => 'ℹ️', 'codepoint' => '2139', 'asset_path' => $assetBasePath . '2139.png', 'label' => 'Information'],
        ['id' => 'house', 'emoji' => '🏠', 'codepoint' => '1f3e0', 'asset_path' => $assetBasePath . '1f3e0.png', 'label' => 'House'],
        ['id' => 'bust', 'emoji' => '👤', 'codepoint' => '1f464', 'asset_path' => $assetBasePath . '1f464.png', 'label' => 'Bust In Silhouette'],
        ['id' => 'paperclip', 'emoji' => '📎', 'codepoint' => '1f4ce', 'asset_path' => $assetBasePath . '1f4ce.png', 'label' => 'Paperclip'],
        ['id' => 'outbox', 'emoji' => '📤', 'codepoint' => '1f4e4', 'asset_path' => $assetBasePath . '1f4e4.png', 'label' => 'Outbox Tray'],
        ['id' => 'inbox', 'emoji' => '📥', 'codepoint' => '1f4e5', 'asset_path' => $assetBasePath . '1f4e5.png', 'label' => 'Inbox Tray'],
        ['id' => 'email', 'emoji' => '📧', 'codepoint' => '1f4e7', 'asset_path' => $assetBasePath . '1f4e7.png', 'label' => 'Email'],
        ['id' => 'floppy-disk', 'emoji' => '💾', 'codepoint' => '1f4be', 'asset_path' => $assetBasePath . '1f4be.png', 'label' => 'Floppy Disk'],
        ['id' => 'clipboard', 'emoji' => '📋', 'codepoint' => '1f4cb', 'asset_path' => $assetBasePath . '1f4cb.png', 'label' => 'Clipboard'],
        ['id' => 'magnifier-left', 'emoji' => '🔍', 'codepoint' => '1f50d', 'asset_path' => $assetBasePath . '1f50d.png', 'label' => 'Magnifying Glass Left'],
        ['id' => 'link', 'emoji' => '🔗', 'codepoint' => '1f517', 'asset_path' => $assetBasePath . '1f517.png', 'label' => 'Link'],
        ['id' => 'repeat', 'emoji' => '🔄', 'codepoint' => '1f504', 'asset_path' => $assetBasePath . '1f504.png', 'label' => 'Repeat'],
        ['id' => 'broom', 'emoji' => '🧹', 'codepoint' => '1f9f9', 'asset_path' => $assetBasePath . '1f9f9.png', 'label' => 'Broom'],
        ['id' => 'eye', 'emoji' => '👁', 'codepoint' => '1f441', 'asset_path' => $assetBasePath . '1f441.png', 'label' => 'Eye'],
    ];
}
